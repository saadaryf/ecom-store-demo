            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@alimran.com</p>
                  <p className="text-gray-600">support@alimran.com</p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600">
                ...
                and bank transfers. All payments are processed securely.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <p className="text-gray-600">
                Yes, we offer professional installation services for most appliances. 
                Our certified technicians ensure proper setup and testing.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Do you provide warranty coverage?</h3>
              <p className="text-gray-600">
                All products come with manufacturer warranty. We also offer extended warranty 
